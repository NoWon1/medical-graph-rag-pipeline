...
with tab_upload:
    ...
    uploaded_file = st.file_uploader(
        ...
        type=["txt", "pdf"],
        help="Upload a clinical report to automatically extract diagnosis, treatment plan, and relevant literature."
    )
    pasted_report = st.text_area(
        "Or paste report text here:",
        height=200,
        placeholder="e.g. Patient presents with Stage II ER+ breast cancer...",
        help="Paste clinical notes or pathology report details directly here."
    )
