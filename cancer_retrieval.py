...
def mmr_rerank(query: str, candidates: List[Document], embed_model: HuggingFaceEmbeddings, k: int = K_MMR_FINAL, lambda_mult: float = MMR_LAMBDA) -> List[Document]:
    ...
    # ⚡ Bolt Optimization: Fully vectorize MMR similarity calculations
    # This avoids nested Python loops and repeated cosine similarity function calls
    ...
    # L2 normalize query and docs to compute cosine similarity using dot product
