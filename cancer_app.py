...
with tab_upload:
    ...
    uploaded_file = st.file_uploader(
        ...
        help="Upload your clinical report to get a personalised analysis."
    )
    pasted_report = st.text_area(
        "Or paste report text here:", height=200,
        help="Paste the full text of your medical report here if you don't have a file.",
        placeholder="e.g. Diagnosis: Breast Cancer, Stage II..."
    )
